...
# tear down paricipant
kubectl delete job/$PARTICIPANT_ID-create-topic-participant
kubectl delete job/$PARTICIPANT_ID-onboard-cert-generation
#kubectl delete pvc/${PARTICIPANT_ID}-pvc
