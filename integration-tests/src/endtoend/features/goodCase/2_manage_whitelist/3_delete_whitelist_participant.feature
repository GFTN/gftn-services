...
Feature: World Wire
  ...
  Scenario Outline: Add participant to whitelist
    ...
    When id: <participant_id> delete participant: <whitelist_target_participant_id> from whitelist service - whitelistURL: <global_whitelist_url>
    And id: <participant_id> check participant: <whitelist_target_participant_id> was not in whitelist - whitelistURL: <global_whitelist_url>
    ...
    Examples:
      ...
      | "ENV_KEY_PARTICIPANT_1_WL_URL" | "ENV_KEY_PARTICIPANT_1_API_URL" | "ENV_KEY_PARTICIPANT_1_ID" | "ENV_KEY_PARTICIPANT_2_ID"      |
      | "ENV_KEY_PARTICIPANT_1_WL_URL" | "ENV_KEY_PARTICIPANT_2_API_URL" | "ENV_KEY_PARTICIPANT_2_ID" | "ENV_KEY_PARTICIPANT_1_ID"      |