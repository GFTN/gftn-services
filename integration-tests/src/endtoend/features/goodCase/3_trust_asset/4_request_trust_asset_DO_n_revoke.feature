...
Feature: World Wire
  ...
  Scenario Outline: request trust asset
    ...
    And allower participant: <allow_trust_participant_id> send revoke trust request to revoke trust DO asset_code: <participant_trust_asset_code> trustSender: <participant_id> trust_account <participant_trust_asset_account_name>, allowURL:<alow_trust_url>
    Examples:
      ...
      | "ENV_KEY_PARTICIPANT_2_WL_URL" | "ENV_KEY_PARTICIPANT_2_ID" | "ENV_KEY_PARTICIPANT_1_ID" | "ENV_KEY_PARTICIPANT_2_API_URL" | "ENV_KEY_PARTICIPANT_1_ISSUE_REVOKE_ASSET" | "ENV_KEY_PARTICIPANT_1_ISSUE_ASSET_TYPE" | "ENV_KEY_PARTICIPANT_1_ID"     | "ENV_KEY_PARTICIPANT_2_TRUST_ASSET_LIMIT" | "ENV_KEY_PARTICIPANT_2_ISSUING_ACCOUNT_NAME" | "ENV_KEY_PARTICIPANT_1_API_URL" |
